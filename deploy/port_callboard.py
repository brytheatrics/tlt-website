...
CONTACT_SHEET_MODULE = '''
  ...
  function cbShowContactSheetModal(showName, url) {
    ...
    overlay.innerHTML =
      '<div style="background:#fff; border-radius:10px; padding:24px; max-width:420px; width:calc(100% - 40px); box-shadow:0 4px 24px rgba(0,0,0,0.15);">' +
        ...
        '<p style="margin:0 0 20px; color:#666; font-size:13px;">Regenerate to pick up any recent cast or crew changes. The old one moves to trash.</p>' +
  ...
  function cbShowScheduleModal(showName, url) {
    ...
    overlay.innerHTML =
      '<div style="background:#fff; border-radius:10px; padding:24px; max-width:420px; width:calc(100% - 40px); box-shadow:0 4px 24px rgba(0,0,0,0.15);">' +
        ...
        '<p style="margin:0 0 20px; color:#666; font-size:13px;">Regenerate to pull the latest dates from the sheet. The old schedule moves to trash.</p>' +
        '<div style="display:flex; gap:8px; justify-content:flex-end; flex-wrap:wrap;">' +
